...
Config.blips = {
    [1] = {
        coords = vector3(429.29, -983.25, 30.71),
        sprite = 60,
        display = 4,
        scale = 0.6,
        colour = 38,
    ...
    [2] = {
        coords = vector3(1855.49, 3682.71, 34.27),
        sprite = 60,
        display = 4,
        scale = 0.6,
        colour = 28,
...
Config.TargetSystem = 'interact' -- Target system you want to use : qb-target / qtarget / ox_target
...
Config.Inventory = 'mad-inventory'
...
Config.Locations = {
    -- =================== Gabz maps coords
    -- ["duty"] = {
    --     [1] = vector3(441.23, -982.09, 30.69), -- LSPD
    --     [2] = vector3(1853.66, 3690.71, 33.89), -- Sandy
    --     [3] = vector3(-446.31, 6012.68, 31.48), -- Paleto
    -- },
    -- -- ["vehicle"] = {
    ...
    -- -- },
    -- ["stash"] = {
    --     [1] = vector3(479.16, -996.61, 30.69), -- LSPD
    --     [2] = vector3(1846.77, 3680.84, 34.27), -- Sandy
    --     [3] = vector3(-457.73, 6014.09, 31.48), -- Paleto
    -- },
    -- ["impound"] = {
    --     [1] = vector3(479.08, -1022.54, 28.01), -- LSPD
    --     [2] = vector3(1850.89, 3710.36, 33.22), -- Sandy
    --     [3] = vector3(-452.85, 6071.85, 31.42), -- Paleto
    -- },
    -- ["helicopter"] = {
    --     [1] = vector4(460.24, -980.18, 43.69, 181.43), -- LSPD
    --     [2] = vector4(-462.15, 5994.77, 31.25, 134.84), -- Paleto
    -- },
    -- ["helispawn"] = { -- The numbers [1] must match the numbers in [helicopter]
    --     [1] = vector4(449.16, -981.23, 43.69, 165.79), -- LSPD
    --     [2] = vector4(-475.18, 5988.43, 31.72, 317.27), -- Paleto
    -- },
    -- ["armory"] = {
    --     [1] = vector3(482.51, -995.62, 30.69), -- LSPD
    --     [2] = vector3(1841.99, 3690.24, 34.27), -- Sandy
    --     [3] = vector3(-438.51, 6006.93, 31.48), -- Paleto
    -- },
    -- ["trash"] = {
    --     [1] = vector3(440.15, -978.25, 30.66), -- LSPD
    --     [2] = vector3(1852.94, 3692.07, 34.27), -- Sandy
    --     [3] = vector3(-428.7, 5996.49, 31.48), -- Paleto
    -- },
    -- ["fingerprint"] = {
    --     [1] = vector3(473.12, -1007.48, 26.27), -- LSPD
    --     [2] = vector3(1848.53, 3680.82, 30.26), -- Sandy
    --     [3] = vector3(-433.36, 5990.6, 31.48), -- Paleto
    -- },
    -- ["evidence"] = {
    --     [1] = vector3(472.79, -993.10, 26.27), -- LSPD
    --     [2] = vector3(1855.37, 3699.57, 34.27), -- Sandy
    --     [3] = vector3(-436.65, 6000.41, 31.48), -- Paleto
    -- },
    -- ["labs"] = {
    ...
    -- =================== Nopixel maps coords
    ["duty"] = {
        [1] = vector3(450.38, -981.82, 30.99), -- LSPD
        [2] = vector3(1861.36, 3688.72, 34.24), -- Sandy
        [3] = vector3(-446.77, 6012.72, 32.29), -- Paleto
    },
    -- ["vehicle"] = {
    --     [1] = vector4(438.08, -989.79, 25.71, 263.16), -- LSPD
    --     [2] = vector4(-458.86, 6031.5, 31.34, 139.15), --BCSO
    --     [3] = vector4(1858.95, 3681.95, 33.83, 219.83), -- Sandy
    -- },
    -- ["vehspawn"] = { -- The numbers [1] must match the numbers in [vehicle]
    ...
    -- },
    ["stash"] = {
        [1] = vector3(466.04, -998.25, 31.12), -- LSPD
        [2] = vector3(1840.58, 3696.74, 34.24), -- Sandy
        [3] = vector3(-449.49, 6013.77, 37.0), -- Paleto
    },
    ["impound"] = {
        [1] = vector3(427.53, -994.97, 25.71), -- LSPD
        -- [2] = vector3(1850.89, 3710.36, 33.22), -- Sandy
        -- [3] = vector3(-452.85, 6071.85, 31.42), -- Paleto
    },
    ["helicopter"] = {
        [1] = vector4(466.19, -999.55, 45.21, 7.75), -- LSPD
        [2] = vector4(-462.15, 5994.77, 31.25, 134.84), -- Paleto
    },
    ["helispawn"] = { -- The numbers [1] must match the numbers in [helicopter]
        [1] = vector4(477.07, -1003.32, 45.91, 272.96), -- LSPD
        [2] = vector4(-475.18, 5988.43, 31.72, 317.27), -- Paleto
    },
    -- ["armory"] = {
    --     [1] = vector3(482.51, -995.62, 30.69), -- LSPD
    ...
    -- },
    ["trash"] = {
        [1] = vector3(450.5, -986.84, 30.34), -- LSPD
        -- [2] = vector3(1852.94, 3692.07, 34.27), -- Sandy
        -- [3] = vector3(-428.7, 5996.49, 31.48), -- Paleto
    },
    ["fingerprint"] = {
        [1] = vector3(475.3, -1002.55, 26.33), -- LSPD
        [2] = vector3(1858.75, 3706.3, 34.24), -- Sandy
        [3] = vector3(-452.37, 5997.73, 27.58), -- Paleto
    },
    ["evidence"] = {
        [1] = vector3(478.45, -988.62, 31.06), -- LSPD
        [2] = vector3(1848.55, 3701.2, 34.24), -- Sandy
        [3] = vector3(-452.11, 5997.13, 37.0), -- Paleto
    },
    ["labs"] = {
        [1] = vector3(475.05, -988.15, 30.66), -- LSPD
        [2] = vector3(1852.23, 3702.97, 34.24), -- Sandy
    },
    ["stations"] = {
        [1] = {label = "Los Santos Police Department", coords = vector4(443.94, -981.86, 48.83, 91.44), sprite= 137, scale= 0.7, colour= 29},
        [2] = {label = "Blaine County Sheriffs Office", coords = vector4(1862.37, 3691.66, 34.26, 289.38), sprite= 137, scale= 0.7, colour= 47},
        [3] = {label = "Blaine County Office", coords = vector4(-446.93, 6012.51, 32.29, 36.49), sprite= 137, scale= 0.7, colour= 47},
        [4] = {label = "Prison", coords = vector4(1690.11, 2597.15, 45.56, 182.32), sprite= 137, scale= 0.7, colour= 1},
    },
}
