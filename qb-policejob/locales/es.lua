local Translations = {
    error = {
        ...
        vehicle_tie = 'No puedes poner bridas a alguien en un vehículo',
        no_cuff = 'No tienes esposas',
        no_ziptie = 'No tienes esposas bridas',
        no_knife = 'No tienes cuchillos',
        no_cutter = 'No tienes un cutter',
        ...
        not_online = 'La persona no esta conectada',
        clearspawnpoint = 'La ubicación del spawn está bloqueada!',
        alradyhaveheli = 'Ya tienes un helicoptero!',
        already_cuffed = 'El jugador ya esta esposado/atad9!',
    ...
    success = {
        ...
        untied = 'Te han quitado las bridas',
    ...
    info = {
        ...
        slot = 'Hueco nº (1,2,3)',
        current_evidence = 'Evidence #%{value} | Drawer #%{value2}',
        general_current_evidence = 'Evidencias Generales | #%{value}',
    ...
    menu = {
        ...
        evd_drawer_h = 'Armario de pruebas',
