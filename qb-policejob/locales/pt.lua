local Translations = {
    error = {
        ...
        vehicle_tie = 'Você pode algemar alguém dentro de um veículo',
        no_cuff = 'Não tens algemas contigo',
        no_ziptie = 'Você não tem braçadeiras com você',
        no_knife = 'Você não tem uma faca com você',
        no_cutter = 'Você não tem algo para cortar',
        ...
        fine_yourself = 'Você não pode se multar a si mesmo',
        not_online = "Esta pessoa não está online",
        clearspawnpoint = 'A localização da Spawn está bloqueada, limpe o ponto de geração!',
        alradyhaveheli = 'Você já tem um helicóptero!',
        already_cuffed = 'A pessoa já está algemada!',
        where_looking = 'Onde você está olhando ?Fique do lado direito!',
        cant_cut = 'Você não pode abrir o item com isso!',
        not_enough_money = 'Você não tem dinheiro suficiente!',
        break_out = 'O suspeito conseguiu tirar as algemas!'
    },
    success = {
        uncuffed = 'Foste desalgemado',
        untied = 'Você foi desalgemado',
        ...
        beingonduty = 'Você está de Serviço',
        beingoffduty = 'Você está fora de Serviço',
    },
    info = {
        mr = 'Sr.',
        mrs = 'Sra.',
        ...
        general_current_evidence = 'Evidências Gerais | #%{value}',
        ...
        received_fine = 'A recuperação do dívida estatal recuperou automaticamente as multas devidas'
    },
    evidence = {
    ...
    menu = {
        ...
        evd_drawer_h = 'Gaveta de evidências',
        evd_drawer_b = 'Você pode acessar a gaveta inserindo um número de evidência',
        evd_stash_h = 'Evidências Gerais',
        evd_stash_b = 'O estoque de evidências que você pode usar em geral',
        dty_onduty = 'De Serviço',
        dty_offduty = 'Fora de Serviço',
        dty_beonduty = 'Entrar ao Serviço',
        dty_beoffduty = 'Sair de Serviço',
        spawn_heli = 'Pedir Helicóptero',
